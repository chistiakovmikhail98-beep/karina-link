            ...
            >
              ...
              <span
                className={`absolute left-3 text-[11px] font-bold transition-opacity duration-200 ${
                  hasExperience ? "opacity-0" : "text-white/50 opacity-100"
                }`}
              >
                Нет
              </span>
        ...
        <div ref={resultsRef} className="mt-6 space-y-4 fade-in-up">
          ...
          <div className="rounded-2xl border border-[#C8A55A]/20 bg-gradient-to-br from-[#C8A55A]/10 to-transparent p-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="rounded-xl bg-white/[0.04] p-3 text-center">
                ...
                <div className="text-lg font-extrabold text-white/70 leading-tight">
                  {fmt(animPessimistic)}
                </div>
                <div className="text-[10px] text-white/30 mt-0.5">₽</div>
              </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
            ...
            <div className="flex items-center justify-center gap-1 flex-wrap text-sm">
              <span className="rounded-lg bg-white/[0.06] px-2.5 py-1.5 font-bold text-white">
                {fmt(audience)}
              </span>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
            ...
            <div className="mb-3">
              <div className="flex items-center justify-between mb-1.5">
                <span className="text-xs text-white/50">Самостоятельно</span>
                <span className="text-xs font-bold text-white/70">{fmt(animRealistic)} ₽</span>
              </div>
          ...
          <div className="rounded-2xl border border-[#C8A55A]/15 bg-gradient-to-r from-[#C8A55A]/[0.07] to-transparent p-4">
            ...
            <p className="text-[11px] text-white/40 mb-3">
              Новый чек: <span className="font-bold text-white/60">{fmt(raisedPrice)} ₽</span> вместо {fmt(price)} ₽
            </p>
            <div className="flex items-center gap-3">
              <div className="flex-1 rounded-xl bg-white/[0.05] p-3 text-center">
                <div className="text-[10px] text-white/40 mb-1">Было</div>
          ...
          <button
            ...
            className="w-full rounded-xl border border-white/10 bg-white/[0.03] py-3 text-sm font-semibold text-white/50 transition hover:border-white/20 hover:text-white/70"
          >
