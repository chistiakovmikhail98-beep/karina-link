        ...
        <div className="flex items-center gap-3">
          {step > 1 && (
            <button
              type="button"
              onClick={onBack}
              className="flex items-center gap-1 rounded-full border border-white/10 px-4 py-2.5 text-sm text-white/50 transition-all hover:border-white/20 hover:text-white/70"
            >
              <svg
                className="w-4 h-4"
                fill="none"
...
function AnalyzingScreen() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20">
      ...
      <p className="text-white/40 text-sm">Это займёт несколько секунд</p>
